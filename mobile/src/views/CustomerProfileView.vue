...
<style scoped>
.customer-page { width:min(100%,42rem); margin:0 auto; padding:max(1.25rem,env(safe-area-inset-top)) 1rem calc(6rem + env(safe-area-inset-bottom)) }.customer-page header h1,.profile-card h2 { font-family:var(--font-display); color:var(--casa-deep-palm) }.customer-page header p { margin:.25rem 0 }.notice { padding:.75rem; border-radius:var(--radius-control); background:var(--casa-success-bg); color:var(--casa-success) }.loading { padding:2rem; text-align:center; color:var(--casa-muted) }.profile-card { display:grid; gap:1rem; margin-top:1rem; padding:1rem; border:1px solid var(--casa-border); border-radius:var(--radius-operation); background:var(--casa-paper); box-shadow:var(--shadow-card) }.identity { display:flex; justify-content:space-between; gap:1rem; padding:.75rem; border-radius:var(--radius-control); background:var(--casa-sand); color:var(--casa-deep-palm) }.profile-card label>span { display:block; margin-bottom:.35rem; font-weight:700 }.profile-card input,.profile-card textarea,.profile-card select { width:100%; min-height:48px; border:1px solid var(--casa-border-strong); border-radius:var(--radius-control); background:#fff; padding:.7rem .75rem; color:var(--casa-ink); font:inherit }.profile-card textarea { min-height:96px; resize:vertical }.profile-card input:disabled { background:var(--casa-sand); color:var(--casa-muted) }.profile-card label small { display:block; margin-top:.35rem; color:var(--casa-muted) }.profile-card .primary,.profile-card .secondary,.sign-out { min-height:48px; border-radius:var(--radius-control); font:inherit; font-weight:800 }.profile-card .primary { border:0; background:var(--casa-palm); color:#fff }.profile-card .secondary { border:1px solid var(--casa-palm); background:var(--casa-success-bg); color:var(--casa-deep-palm) }.sign-out { width:100%; margin-top:1rem; border:1px solid var(--casa-error); background:var(--casa-error-bg); color:var(--casa-error) }.profile-card button:disabled,.sign-out:disabled { opacity:.55 }
</style>
